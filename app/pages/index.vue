...
<template>
	<div class="h-screen flex overflow-hidden bg-black text-white">
		<div class="w-1/4 h-full flex flex-col justify-between p-16 bg-black border-r border-gray-800">
			<div>
				<div class="mb-16">
		...
		<div class="w-3/4 h-full overflow-y-auto bg-white text-black" @scroll="handleScroll" ref="scrollContainer">
			<section id="about" class="min-h-screen flex items-center p-16">
				<div class="max-w-lg">
					...
					<p class="text-lg leading-relaxed text-gray-700 mb-8">
						...
						tudásom, elsősorban a backend területén. Folyamatosan igyekszem lépést tartani a legfrissebb
						iparági sztenderdekkel.
					</p>
					<p class="text-lg leading-relaxed text-gray-700 mb-8">
						Bár hosszú távon a történelem irányába szeretnék továbblépni, nyitott vagyok bármilyen
						együttműködésre, ahol fejlődhetek és kamatoztathatom a meglévő ismereteimet.
					</p>
